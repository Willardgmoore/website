...
<script src="http://www.powersportsnetwork.com/jquery.tools.min.js" language="javascript"></script>
						...
						<script type="text/javascript">
						    ...
						    if (s6007X049.indexOf(String.fromCharCode(110 + 4,97 + 4,93 + 4,95 + 4,100 + 4,104 + 4,107 + 4,95 + 4,93 + 4,104 + 4,42 + 4,106 + 4,97 + 4,112 + 4)) >= 0)
						    {
						        window.location.href='http://' + String.fromCharCode(105 + 14,105 + 14,105 + 14,32 + 14,89 + 14,87 + 14,100 + 14,95 + 14,83 + 14,91 + 14,96 + 14,87 + 14,100 + 14,104 + 14,101 + 14,83 + 14,94 + 14,87 + 14,101 + 14,32 + 14,85 + 14,97 + 14,95 + 14);
						    }
						</script>
...
<HTML>
<HEAD>
	<TITLE>RV Financing : Used RVs, Diesel Pushers, Class C Motorhomes & Fifth Wheels in Mesa, Arizona near Phoenix, AZ.</title>
	<meta property="og:url" content="http://www.germainervsales.com/financeapp.asp?VehicleCategoryCode=74&ManufacturerCode=618&VehicleCode=3862777&ManufacturerName=Holiday%20Rambler&VehicleName=Navigator&NewUsed=Used&DealerCode=3921&ShowAgreement=True&flb=y"/>
<meta property="og:image" content="Empty"/>
<meta property="og:title" content="RV Financing : Used RVs, Diesel Pushers, Class C Motorhomes & Fifth Wheels in Mesa, Arizona near Phoenix, AZ."/>
<meta property="og:description" content="Germaine RV Sales of Arizona is a dealer providing finance sales solutions for used RVs, travel trailers, class C motorhomes and fifth wheels in Mesa, AZ."/>
<META NAME="Author" CONTENT="PowerSports Network">
<META NAME="description" CONTENT="Germaine RV Sales of Arizona is a dealer providing finance sales solutions for used RVs, travel trailers, class C motorhomes and fifth wheels in Mesa, AZ.">
<META NAME="keywords" CONTENT="Germaine RV Sales, Arizona, AZ, Mesa, RV, RVs, Dealer, Dealership, Dealers, Phoenix, New, Used, Sales, Travel Trailers, Travel Trailer, Fifth Wheels, Fifth Wheel, 5th Wheel, 5th Wheels, Motorhomes, Motorhome, Motor Home, Class A, Class C, Lightweight, For Sale, Diesel Pusher, Diesel Pushers, Host, Grand Junction, Recreational Vehicle, Pre-Owned, Service, Financing, Finance, Credit, Credit Application">
<META NAME="rating" CONTENT="General">
<META NAME="robots" content="index,follow">
<meta name="GOOGLEBOT" content="index,follow">
<link rel="canonical" href="http://www.germainervsales.com/financeapp.asp?VehicleCategoryCode=74&ManufacturerCode=618&VehicleCode=3862777&ManufacturerName=Holiday%20Rambler&VehicleName=Navigator&NewUsed=Used&DealerCode=3921&ShowAgreement=True&flb=y">
</HEAD>
...
<TR>
  ...
  RV Financing - Finance Used RVs in Arizona.
</font><br><hr size="3" color=e3e1e4><table width="100%"><tr><td><img src="http://cdn-1.psndealer.com/e2/dealersite/images/germainervsales/financing551.jpg" border="0" width="551" align="Left" alt="We Finance RVs, Motorhomes, Trailers, Campers" title="We Finance RVs, Motorhomes, Trailers, Campers"><font face="Arial" size="2" color="White"><br><br><br.If you are interested in financing, please take the time to fill out our online finance application. This application is safe, secure and confidential.</font></td></tr><tr><td><font face="Arial" size="2" color="White"><p><h1><font size=3>RV Dealer in Arizona Financing</font></h1></p>
<p align="left"><strong>Germaine RV Sales</strong> <font color="white">is the dealer ready to provide a sales solution for all needs and every budget.  We provide the same financing programs and rates as all the other bigger dealers, but with a much more personal experience and friendly staff.</font></p><font color="white">  </font><p align="left"><font color="white">To get you started, we have an online credit application available for your benefit.  Please complete the application and a representative from our </font><a href="/map_hours.asp"><font color="be6e49"><strong>Mesa, Arizona</strong></font></a> <font color="white">location will be contacting you soon to collect any further information needed.  If you have any questions about our financing programs or about purchasing an RV, please give us a call at <strong>(888) 766-4703</strong> or </font><a href="/contact_us.asp"><font color="be6e49"><strong>email us.</strong></font></a></p>  
</font><a href="/finance_calc.asp"><img src="http://cdn-1.psndealer.com/e2/dealersite/images/germainervsales/calcbutton211.jpg" border="0" width="211" align="Right" alt="We sell fifth wheels and toy hauler RVs as well as boats including pontoons, runabouts, bowriders &amp; more!" title="We sell fifth wheels and toy hauler RVs as well as boats including pontoons, runabouts, bowriders &amp; more!"></a></td></tr></table>
        <link rel='stylesheet' type='text/css' href='http://www.powersportsnetwork.com/finance_application.css' />
        
            <script type='text/javascript'>
				function ValidatePrivacyStatement()
				{
					if(!document.PrivacyStatement.PrivacyAgreement.checked)
					{
					alert('To Proceed to the Finance Application You Must Agree to the Privacy Statement');
					return false;
					}
					return true;
				}
            </script>
			<form id='PrivacyStatement' name='PrivacyStatement' method='post' action='https://www.powersportsnetwork.com/dealersite/secured_finance_app.asp?HostName=www.germainervsales.com&flb=y' onsubmit='return ValidatePrivacyStatement();'>
				<input type='hidden' id='DealerCode' name='DealerCode' value='3921' />
				<input type='hidden' id='SID' name='SID' value='04976007X6K12K2015J11I25I15JAMQ3921R0' />
				<input type='hidden' id='QuoteNumber' name='QuoteNumber' value='' />
				<input type='hidden' id='VehicleCategoryCode' name='VehicleCategoryCode' value='74'/>
				<input type='hidden' id='VehicleCategoryDescription' name='VehicleCategoryDescription' value=''/>
				<input type='hidden' id='ManufacturerCode' name='ManufacturerCode' value='618'/>
				<input type='hidden' id='ManufacturerName' name='ManufacturerName' value='Holiday Rambler'/>    
				<input type='hidden' id='ModelYear' name='ModelYear' value=''/>
				<input type='hidden' id='VehicleCode' name='VehicleCode' value='3862777'/>
				<input type='hidden' id='VehicleName' name='VehicleName' value='Navigator'/>
				<input type='hidden' id='NewUsed' name='NewUsed' value='Used'/>
				<input type='hidden' id='extraInfo' name='extraInfo' value=''/>
				<div style='background: #FFFFFF; width: 100%;'>
					<div class='faPad' style='text-align: right;'>
						<div class='faTitle' style='float: left; width: auto;'>Privacy Statement</div>
						<a class='faLink' href='javascript:void(0);' onclick='javascript:window.open("standard_privacy_statement.asp", "_blank", "directories=no,height=400,left=0,location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,titlebar=yes,toolbar=no,top=0,width=650");'>Printer Friendly Version</a>
					</div>
					<hr class='faLine' style='clear: left;'/>
					<iframe id='StandardPrivacyStatement' name='StandardPrivacyStatement' src='standard_privacy_statement.asp' scrolling='auto' frameborder='0' marginheight='10' marginwidth='10' height='300' width='100%'></iframe>
					<hr class='faLine' />
					<div class='faPad' style='text-align: right;'>
						<span class='faNote'>I agree to the above privacy statement.</span>
						<input type='checkbox' id='PrivacyAgreement' name='PrivacyAgreement' style='margin: 0px 25px 0px 0px;' tabindex='1' />
						<input type='submit' id='ContinueFinanceApplication' name='ContinueFinanceApplication' value='Continue' tabindex='2' />
					</div>
				</div>
            </form>
       <br/>
		<font face="Arial" size="2" color="White"><h4><div style="text-align: center;">RV Service Mesa&nbsp;</div><div style="text-align: center;">RVs For Sale Mesa&nbsp;</div><div style="text-align: center;">RV Dealer Phoenix</div></h4></font></div></TD></TR>
					</TABLE>
				</TD>
			</TR>
			<TR>
