...
<HTML>
<HEAD>
	<TITLE>Parts & Accessories for Sale in Arizona: Parts for New & Used RVs, Diesel Pushers, Fifth Wheels & Class C Motorhomes at a RV Dealer in Mesa AZ</title>
	<meta property="og:url" content="http://www.germainervsales.com/parts_01.asp"/>
<meta property="og:image" content="Empty"/>
<meta property="og:title" content="Parts & Accessories for Sale in Arizona: Parts for New & Used RVs, Diesel Pushers, Fifth Wheels & Class C Motorhomes at a RV Dealer in Mesa AZ"/>
<meta property="og:description" content="Germaine RV Sales has new & used RVs for sale, service & parts & accessories in Mesa, Arizona. Your dealer for the part you need for RVs, travel trailers, class C motorhomes & fifth wheels by Host, Max Lite & others in AZ."/>
<META NAME="Author" CONTENT="PowerSports Network">
<META NAME="description" CONTENT="Germaine RV Sales has new & used RVs for sale, service & parts & accessories in Mesa, Arizona. Your dealer for the part you need for RVs, travel trailers, class C motorhomes & fifth wheels by Host, Max Lite & others in AZ.">
<META NAME="keywords" CONTENT="Germaine RV Sales, Arizona, AZ, Mesa, RV, RVs, Dealer, Dealership, Dealers, Phoenix, New, Used, Sales, Travel Trailers, Travel Trailer, Fifth Wheels, Fifth Wheel, Diesel Pusher, Diesel Pushers, 5th Wheel, 5th Wheels, Motorhomes, Motorhome, Motor Home, Class A, Class C, Lightweight, For Sale, Host, Grand Junction, Recreational Vehicle, Pre-Owned, Parts, Part, Accessory, Accessories, Renovation, Repair">
<META NAME="rating" CONTENT="General">
<META NAME="robots" content="index,follow">
<meta name="GOOGLEBOT" content="index,follow">
<link rel="canonical" href="http://www.germainervsales.com/parts_01.asp">
</HEAD>
...
<TR>
  ...
  Parts Requests For New &amp; Used Motorhomes in AZ - Boat Dealer Arizona</font><br><hr size="3" color=e3e1e4><table width="100%"><tr><td><font face="Arial" size="2" color="White">
  <p></p><h1><font size="3">RV Repair, Parts and Service in Mesa, AZ serving the Phoenix Area</font></h1><p></p>   <div style="text-align: center;">We have parts available for new and used RVs including&nbsp;Diesel&nbsp;Pusher Motorhomes! RV repair, renovation&nbsp;available&nbsp;in Mesa, AZ serving the Phoenix area. Boat parts available as well for Tige,  <a class="dealer_default_inverted_link" <a="" href="http://www.germainervsales.com/pre_owned_list.asp?GroupBy=&amp;newused=B&amp;mfg=83&amp;category=0&amp;TypeID=0&amp;ModelYearFrom=&amp;ModelYearThru=&amp;PriceFrom=&amp;PriceThru=&amp;lengthMin=&amp;lengthMax=&amp;feetmeters=feet&amp;s=search&amp;industry=2&amp;submit_form.x=29&amp;submit_form.y=1" target="" title="">Premier Pontoon</a> and Larson! Make us your source for RV Repair and Parts in the Phoenix Area. Call our dealership at 888-766-4703 or stop by today!&nbsp;</div>        
</font></td></tr><tr><td><font face="Arial" size="2" color="White">
<h4><br></h4>
</font></td></tr></table>

<div id="returnCodeCheck">
...
function changeIt()
{
	...
	if (noti==2)
	{
		document.getElementById("my_div").innerHTML = 
			document.getElementById("my_div").innerHTML + "<table border='0'><tr><td><input maxlength='128' type=text size='30' id=PartNumber" 
				+ (noti - 1) + " name=PartNumber></td><td><input maxlength='128' type=text size='30' id=PartDescription" 
				+ (noti - 1) + " name=PartDescription></td><td><input maxlength='10' type=text size='10' id=PartQuantity"
				+ (noti - 1) + " name=PartQuantity></td></tr></table><div id='my_div" + noti + "'></div>";
	}
	else
	{
		document.getElementById("my_div" + (noti-1)).innerHTML = 
			document.getElementById("my_div" + (noti-1)).innerHTML + "<table border='0'><tr><td><input maxlength='128' type=text size='30' id=PartNumber" 
				+ (noti - 1) + " name=PartNumber></td><td><input maxlength='128' type=text size='30' id=PartDescription" 
				+ (noti - 1) + " name=PartDescription></td><td><input maxlength='10' type=text size='10' id=PartQuantity"
				+ (noti - 1) + " name=PartQuantity></td></tr></table><div id='my_div" + noti + "'></div>";
	}
...
function changeIt2()
{
	...
	document.getElementById("your_div").innerHTML = 
		document.getElementById("your_div").innerHTML + "<input type=hidden name='NumberOfParts' value=" + noti + ">"
}
...
function checki()
{
	if (noti==1) 
	{
		while($('#PartNumber' + noti).length > 0) noti++;
	}
}

function stripCommas()
{
	document.getElementById("PartNumber").value = document.getElementById("PartNumber").value.replace(/,/g, " ");
	document.getElementById("PartDescription").value = document.getElementById("PartDescription").value.replace(/,/g, " ");
	document.getElementById("PartQuantity").value = document.getElementById("PartQuantity").value.replace(/,/g, " ");
	
	for (var j=1; j < noti; j++)
	{ 
		document.getElementById("PartNumber" + j).value = document.getElementById("PartNumber" + j).value.replace(/,/g, " ");
		document.getElementById("PartDescription" + j).value = document.getElementById("PartDescription" + j).value.replace(/,/g, " ");
		document.getElementById("PartQuantity" + j).value = document.getElementById("PartQuantity" + j).value.replace(/,/g, " ");
	}
}

function submitStuff(that)
{
	stripCommas();
	return ValidateForm(that);
}
</script>


<form class="default_form" method="post" name="Parts" id="partsForm" action="/parts_01.asp" onsubmit="return submitStuff(this)">
<input type="hidden" name="dc" value="3921" />
<input type="hidden" name="FormType" value="3" />
<input type="hidden" name="didJavascript" value="" />
<table>
	<tr>
	  <td colspan="2"><b>* Fields with an asterisk are required</b></td>
    </tr>
	<tr>
		<td><b>First Name *</b></td>
		<td><input maxlength="128" type="text" name="FirstName" size="40" value="" /></td>
	</tr>	
	<tr>
		<td><b>Last Name *</b></td>
		<td><input maxlength="128" type="text" name="LastName" size="40" value="" /></td>
	</tr>
		
	<tr>
		<td><b>Street Address</b></td>
		<td><input maxlength="128" type="text" name="Address1" size="40" value="" /></td>
	</tr>
	<tr>
		<td><b>City</b></td>
		<td><input maxlength="128" type="text" name="City" size="40" value="" /></td>
	</tr>
	<tr>
		<td><b>State/Province</b></td>
		<td><select name="State" size="1">
			<option value="" >Select a State/Province </option>
			 <option value="AL">Alabama</option><option value="AK">Alaska</option><option value="AZ">Arizona</option><option value="AR">Arkansas</option><option value="CA">California</option><option value="CO">Colorado</option><option value="CT">Connecticut</option><option value="DE">Delaware</option><option value="DC">District of Columbia</option><option value="FL">Florida</option><option value="GA">Georgia</option><option value="HI">Hawaii</option><option value="ID">Idaho</option><option value="IL">Illinois</option><option value="IN">Indiana</option><option value="IA">Iowa</option><option value="KS">Kansas</option><option value="KY">Kentucky</option><option value="LA">Louisiana</option><option value="ME">Maine</option><option value="MD">Maryland</option><option value="MA">Massachusetts</option><option value="MI">Michigan</option><option value="MN">Minnesota</option><option value="MS">Mississippi</option><option value="MO">Missouri</option><option value="MT">Montana</option><option value="NE">Nebraska</option><option value="NV">Nevada</option><option value="NH">New Hampshire</option><option value="NJ">New Jersey</option><option value="NM">New Mexico</option><option value="NY">New York</option><option value="NC">North Carolina</option><option value="ND">North Dakota</option><option value="OH">Ohio</option><option value="OK">Oklahoma</option><option value="OR">Oregon</option><option value="PA">Pennsylvania</option><option value="RI">Rhode Island</option><option value="SC">South Carolina</option><option value="SD">South Dakota</option><option value="TN">Tennessee</option><option value="TX">Texas</option><option value="UT">Utah</option><option value="VT">Vermont</option><option value="VA">Virginia</option><option value="WA">Washington</option><option value="WV">West Virginia</option><option value="WI">Wisconsin</option><option value="WY">Wyoming</option><option value="--">-----</option><option value="AB">Alberta</option><option value="BC">British Columbia</option><option value="MB">Manitoba</option><option value="NB">New Brunswick</option><option value="NL">Newfoundland</option><option value="NT">Northwest Territory</option><option value="NS">Nova Scotia</option><option value="NU">Nunavut</option><option value="ON">Ontario</option><option value="PE">Prince Edward Island</option><option value="QC">Quebec</option><option value="SK">Saskatchewan</option><option value="YT">Yukon Territory</option><option value="--">-----</option><option value="AS">American Samoa</option><option value="GU">Guam</option><option value="MH">Marshall Islands</option><option value="FM">Micronesia</option><option value="MP">Northern Mariana Islands</option><option value="PW">Palau</option><option value="PR">Puerto Rico</option><option value="VI">US Virgin Islands</option><option value="--">-----</option><option value="AA">Armed Forces Americas</option><option value="AE">Armed Forces Europe</option><option value="AP">Armed Forces Pacific</option><option value="CL">Clarendon</option><option value="HA">Hanover</option><option value="KI">Kingston</option><option value="MA">Manchester</option><option value="PO">Portland</option><option value="SD">St. Andrew</option><option value="SN">St. Ann</option><option value="SC">St. Catherine</option><option value="SE">St. Elizabeth</option><option value="SJ">St. James</option><option value="SM">St. Mary</option><option value="ST">St. Thomas</option><option value="TR">Trelawny</option><option value="WE">Westmoreland</option>
	   </select>
		&nbsp;<b>Zip/Postal Code</b>
		<input maxlength="128" type="text" name="ZIPCode" size="11" value="" />
		</td>
	</tr>
	...
	<tr>
		...
		<td><input maxlength="128" type="text" name="CustomerEmail" size="40" value="" /></td>
	</tr>
	<tr>
		<td><b>Daytime Phone *</b></td>
		<td><input maxlength="128" type="text" name="DayPhone" size="20" value="" /></td>
	</tr>
	<tr>
		<td><b>Evening Phone</b></td>
		<td><input maxlength="128" type="text" name="EveningPhone" size="20" value="" /></td>
	</tr>
	<tr>
		<td><b>Manufacturer *</b></td>
		<td><input maxlength="128" type="text" name="VehicleManufacturer" size="40" value="" /></td>
	</tr>
	<tr>
		<td><b>Model *</b></td>
		<td><input maxlength="128" type="text" name="VehicleModel" size="40" value="" /></td>
	</tr>
	<tr>
		<td><b>Year *</b></td>
		<td><input maxlength="128" type="text" name="VehicleYear" size="4" value="" /></td>
	</tr>
	<tr>
		<td><b>HIN</b></td>
		<td><input maxlength="128" type="text" name="HIN" size="40" value="" /></td>
	</tr>
	<tr>
		<td><b>VIN</b></td>
		<td><input maxlength="128" type="text" name="VIN" size="40" value="" /></td>
	</tr>
</table>
<table width="100%">
	<tr><td></td></tr>
...
<table border="0">
<tr>
	<td class="table_header">Part Number</td>
...
<tr><td><input maxlength="128" type="Text" size="30" name="PartNumber" id="PartNumber" value="" /></td>
<td><input maxlength="128" type="Text" size="30" name="PartDescription" id="PartDescription" value="" /></td>
<td><input maxlength="10" type="Text" size="10" name="PartQuantity" id="PartQuantity" value=""  /></td></tr>
</table>



<div id="my_div"></div>
<input type="button" value="Click to add more parts" onClick="changeIt()">

<div id="your_div"></div>
<table>
<tr><td valign="top"><b>Additional Comments</b></td>
<td><textarea name="CustomerComments" cols="50" rows="10"></textarea></td></tr>
</table>

<br>
	<input type="hidden" id="EmailPreference" name="EmailPreference" value="N">
	<input type="checkbox" id="ReceiveEmailCheckbox" value="N"  onclick="if (document.getElementById('ReceiveEmailCheckbox').checked) {document.getElementById('EmailPreference').value='Y';}else{document.getElementById('EmailPreference').value='N';}">
	<span>Please check here if you would like to receive Email notifications of promotions, sales and special events.</span>
<br><br>
		...
		<div id="recaptcha" style="">
			...
			<div class="g-recaptcha" data-sitekey="6Le-uf8SAAAAACa7bVMPzMoAcdxv0vtLVwLbmOxW" data-stoken="rn0DjENeA3SXDoVomFSmaP-EXIv5a0QhOg3WcdvK0bh2YImWyoMUIVGHG6t5QzrsjKVxhecB7EcJEDs3J6PXaLZZuSGZvgL2mXxBjg87NN0"></div>
		</div>	
		


<div style="margin:0 auto;text-align:center;">
    <input type="submit" value="Submit the Form" name="submit" onMouseDown="stripCommas()" onClick="changeIt2()"/>&nbsp;&nbsp;<input type="reset" name="reset" value="Reset the Form" />
</div>
